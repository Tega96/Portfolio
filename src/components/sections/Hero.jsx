...
import { SiReact, SiNextdotjs, SiTailwindcss, SiNodedotjs, SiMongodb, SiPostgresql, SiDocker, SiJenkins } from 'react-icons/si';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <FadeIn delay={200}>
                        <div className="relative">
                            <div className="relative overflow-hidden rounded-2xl aspect-4/5 ml-auto max-w-[500px] group">
                                ...
                                <div className="absolute bottom-6 left-6 z-20">
                                    <FadeIn delay={500}>
                                        <div className="flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 rounded-full px-6 py-3">
                                            ...
                                            <div className="w-6 h-6 flex items-center justify-center hover:scale-110 transition-transform duration-300">
                                                <SiJenkins className="w-full h-full text-primary" />
                                            </div>
