export const projects = [
    ...
    },
    {
        id: 5,
        title: 'TechJam',
        description: 'A full Stack application that connects tech enthusiast for the purpose of collaborating to build a project',
    ...
    },
    {
        id: 7,
        title: 'DoneWith',
        description: 'Mobile application for Andriod and iOS that allow users to find buyers of whatever product they no longer have use of.',
        image: '/images/projects/projects3.png',
        category: 'Frontend',
...
export const categories = ['All', 'Full Stack', 'Frontend', 'Web Design'];